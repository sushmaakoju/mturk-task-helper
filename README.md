...
### Goal: To receive classification labels and location annotations of vehicles in Images dataset (Aerial view), 
### to analyze results, quality and score the output.
...
* Assumptions for all Jupyter Notebooks/scripts: 
    ...
    * The Jupyter notebook is only an example and MUST be attempted as blind run.
    ...
    * You would have configured Amazon Mechanical Turk anc CLI
    * Always make sure to run any AWS / Mechanical Turk scripts on sandbox environment i.e. developer sandbox. 
    * Although all endpoint urls do point to developer sandbox. It is good idea you get aquainted with this.
